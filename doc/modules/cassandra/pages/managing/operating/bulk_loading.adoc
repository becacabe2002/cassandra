...
* there is enough disk and network capacity for the stream and the follow-up compaction work
...
* disk usage and pending compactions are within the range you expect for the imported SSTables
