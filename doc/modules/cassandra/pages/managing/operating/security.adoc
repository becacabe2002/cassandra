...
xref:cassandra:developing/cql/security.adoc#alter-keyspace[`ALTER KEYSPACE`] and
...
achieved via xref:cassandra:developing/cql/security.adoc#grant-permission[`GRANT PERMISSION`].
